    ...
    <div class="g-form-control">
        <ul class="nav nav-tabs" role="tablist">
            <?php if(!empty($service_types)): ?>
                <?php $number = 0; ?>
                <?php $__currentLoopData = array_reverse($service_types); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
...
<?php endif; ?>
<?php /**PATH E:\Laragon\www\softech\new\themes/Base/Template/Views/frontend/blocks/form-search-all-service/form-search.blade.php ENDPATH**/ ?>